%%writefile /kaggle/buffers/orottick4/randife.py
# ------------------------------------------------------------ #
#                     _ _  __     
...
class RandifeRandomSimulator:
    ...
    def simulate(self, data_df, prd_time_no, prc_time_cnt, prc_runtime, tck_cnt, has_step_log = False, cache_only = False):
        ...
        json_pred = {'time_no': prd_moment.get_time_no(), 'w': x_w, 'n': x_n, 'sim_seed': x_sim_seed, 'prc_time_cnt': prc_time_cnt, 'tck_cnt': tck_cnt, 'sim_cnt': xs_sim_cnt, 'pred': xs_pred, 'ma_rsi': ma_rsi}
